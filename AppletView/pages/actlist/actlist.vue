					...
					<view class="body" style="padding-top: 0px;">
						<view class="list">
							<block v-for="(list,inx) in listData" :key="inx">
								<!-- <view class="videolist shadow animated fadeIn fast" @click="getUrl('../predetails/predetails?id='+list.lineLink,0)" style="background: url(../../static/yd.png) no-repeat bottom right #fff; background-size:90px;"> -->
								<view class="videolist shadow animated fadeIn fast" @click="getUrl(list.tag=='live'?'../predetails/predetails?id='+list.lineLink:'../details/details?id='+list.lineLink,0)" style="background: url(../../static/yd.png) no-repeat bottom right #fff; background-size:90px;">
									<view class="">
										<view class="fl shadow videolistimg ovh pr"  v-bind:style="{ 'background': 'url('+list.picUrl+') no-repeat center','background-size':'cover' }">
										...
										<view class="fr videolistname f13">
											...
											<view class="ovh">
												<view class="fl center">
													...
													<view class="c000">{{list.doctorName}}</view>
												</view>
											</view>
										</view>
									</view>
