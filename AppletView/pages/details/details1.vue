	...
	<view class="h100 pf w100 bF9FBFE">
		<template v-if="issign">
			<view class="pf whtl animated fadeIn fast">
				<view class="dettop">
					<view class="center">
						<video @timeupdate="timeupdate" class="video" :src="videosrc" :poster="videoimg" controls x5-video-player-type="h5" x5-video-player-fullscreen="true" x5-video-orientation="landscape"
					 playsinline webkit-playsinline="true"></video>
					</view>
					...
					uni.downloadFile({
						...
						success: (res) => {
							...
							if (res.statusCode === 200) {
								...
								ctx.drawImage('../../static/ewmbg.png', 0, 0, 722, 474);
								ctx.drawImage(newimgs, 240, 50, 240, 240);
								ctx.drawImage('../../static/ewmlogo.png', 240, 50, 240, 240);
								ctx.restore();
								ctx.draw();
