	...
	<view>
		<view :class="{ 'tui-bottom-popup': isFixed, 'tui-popup-show': isShow && isFixed }">
			...
			<view class="tui-date-box">
				<view class="tui-iconfont tui-font-arrowleft" style="font-size: 18px;" :style="{color:yearArrowColor}" hover-class="tui-opacity"
				 :hover-stay-time="150" v-if="arrowType == 1" @tap="changeYear(0)"></view>
				<view class="tui-iconfont tui-font-arrowleft" style="font-size: 18px;" :style="{color:monthArrowColor}" hover-class="tui-opacity"
				 :hover-stay-time="150" @tap="changeMonth(0)"></view>
				<view class="tui-date_time">{{ showTitle }}</view>
				<view class="tui-iconfont tui-font-arrowright" style="font-size: 18px;" :style="{color:monthArrowColor}" hover-class="tui-opacity"
				 :hover-stay-time="150" @tap="changeMonth(1)"></view>
				<view class="tui-iconfont tui-font-arrowright" style="font-size: 18px;" :style="{color:yearArrowColor}" hover-class="tui-opacity"
			...
			<view class="tui-date-content">
				...
				<view class="tui-date" :class="{'tui-opacity':openDisAbled(year,month,index+1),'tui-start-date':(type==2 && startDate==`${year}-${month}-${index+1}`) ||type==1,'tui-end-date':(type==2 && endDate==`${year}-${month}-${index+1}`) || type==1}"
				 ...
				 @tap="dateClick(index)">
					<view class="tui-date-text pr" :style="{color:isClick(index)?'#fff':'',backgroundColor: isClick(index)?'#ca021b':''}">
	...
	export default {
		...
		methods: {
			...
			isClick(index){
				...
				if(year==this.Currentselection.split('-')[0]&&month==this.Currentselection.split('-')[1]){
					//setTimeout(()=>{
						this.status[this.Currentselection.split('-')[2]].bgColor="#ca021b"
						this.status[this.Currentselection.split('-')[2]].color="#fff"
					//},700)
				}
			...
			changeData() {
				...
				if (this.isChange && this.type == 1) {
					//console.log(this.days,this.daysArr,this.weekday,this.weekdayArr,this.showTitle,this.status)
